define('confluence/api/ajax', [
    ...
    // apis in atlassian send empty responses sometimes, like for DELETE request types the response is generally empty,
    // which jquery 2.x and above cannot parse as JSON. This is an override to jquery's internal json parser which
    // only does JSON.parse assuming the response is a valid JSON string
    $.ajaxSetup({
        converters: {
