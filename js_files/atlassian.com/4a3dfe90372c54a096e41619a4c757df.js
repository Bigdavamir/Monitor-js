<!doctype html>
    ...
    <head>
        ...
        <link rel="canonical" href="https://ace.atlassian.com/events/details/atlassian-oslo-presents-oslo-after-work-social/rollbar.js">

        <title>See Oslo After Work Social at Atlassian Community Events Oslo
</title>
        <meta name="keywords" content="">
        <meta name="description" content="Atlassian Community Events Oslo presents Oslo After Work Social | Oct 24, 2025. Find event and ticket information.
">
...
<meta name="twitter:title" content="Oslo After Work Social" />

    <meta name="twitter:description" content="In-person Event - Team&#x27;25 Europe in Barcelona will be packed with exciting announcements, product news, and inspiration for Atlassian user..." />


<meta name="twitter:image" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/events/blob_Vlhh5iC" />
        ...
        <meta property="og:image" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/events/blob_Vlhh5iC" />
        <meta property="og:image:secure_url" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/events/blob_Vlhh5iC" />
        <meta property="og:image:width" content="1080" />
        <meta property="og:image:height" content="1080" />
    

        <meta property="og:title" content="Oslo After Work Social | Atlassian Community Events" />
        <meta property="og:description" content="In-person Event - Team&#x27;25 Europe in Barcelona will be packed with exciting announcements, product news, and inspiration for Atlassian user..."/>
        <meta property="og:url" content="https://ace.atlassian.com/events/details/atlassian-oslo-presents-oslo-after-work-social/rollbar.js" />
...
<meta property="og:locale" content="en_US" />
    ...
    <meta property="event:start_time" content="Oct 24, 2025, 4:30 PM (CEST)" />
    
    <meta property="event:end_time" content="Oct 24, 2025, 11:30 PM (CEST)" />

<meta property="event:attending_count" content="23" />
<meta property="event:ticket_uri" content="https://ace.atlassian.com/events/details/atlassian-oslo-presents-oslo-after-work-social/#/purchase" />
...
<meta name="twitter:label1" value="Where" />
    ...
    <meta name="twitter:data1" value="In-person Event - Oslo - Oslo Oslo 0157" />

<meta name="twitter:label2" value="When" />

    
    <meta name="twitter:data2" value="Oct 24, 2025, 4:30 PM (CEST)" />
...
<link rel="stylesheet" href="/static/js/ticketwidget.css?v=4ca06c5bf69ab349c7b9499eeea78592081ea99e">
        ...
        <script>
            ...
            Globals.signup_url                  = '/signup/?next=/events/details/atlassian-oslo-presents-oslo-after-work-social/rollbar.js';
            Globals.login_url                   = '/accounts/login/?next=/events/details/atlassian-oslo-presents-oslo-after-work-social/rollbar.js';
            Globals.logout_url                  = '/accounts/logout/?next=/events/details/atlassian-oslo-presents-oslo-after-work-social/rollbar.js';
            ...
            Globals.global_search_key              = '';
            ...
            Globals.global_attendee_index       = 'BpuIqiJh3DgoDCA9pKRhC0a85Vt1saBNz7zmiC9E13L0AatsVnI5q9fX473C5pKx';
...
Globals.eventInfo = {
    ...
    Globals.slug = 'atlassian-oslo-presents-oslo-after-work-social';
    Globals.rsvp_only = true;
    Globals.absoluteURL = 'https://ace.atlassian.com/events/details/atlassian-oslo-presents-oslo-after-work-social/rollbar.js';
    Globals.socialShareText = 'I\u0027m attending {site_title} {chapter_title} w/ {event_title} on {event_start_date}.{event_static_url}';
    Globals.staticURL = 'https://ace.atlassian.com/e/m5h4h5/';
    Globals.twitterHandle = '@atlassian';
    Globals.hideFeeColumn = false;
    Globals.twitterWithFallback = 'Oslo After Work Social';
    Globals.companyHashtag = '#AtlassianCommunity';
    Globals.twitterCompanyWithFallback = '';
    Globals.cityName = 'Oslo';
    Globals.chapterSlug = 'oslo';
    Globals.chapterId = 249;
    Globals.eventDate = 'Oct 24, 2025';
    Globals.eventDateTime = 'Oct 24, 4:30 PM';
    
        Globals.eventInfo.minutesUntilStart = 20378;
        Globals.eventInfo.minutesUntilStartTimer = 20378;
    
    Globals.eventInfo.tickets = [{"id":10849,"event":11351,"title":"General Admission","audience_type":"IN_PERSON","description":"","access_code":"","visible":true,"price":0.0,"fees":0.0,"total_price":0.0,"available":10,"total_count":1000,"sale_start_date":"2025-09-22T14:49:01+02:00","sale_start_date_naive":"2025-09-22T14:49:01","sale_start_date_derived_from_event_publish":true,"sale_end_date":"2025-10-24T23:30:00+02:00","sale_end_date_naive":"2025-10-24T23:30:00","sale_end_date_derived_from_event_end":true,"min_per_order":0,"max_per_order":10,"is_for_sale":true,"can_delete":false,"currency":"USD","waitlist_enabled":false,"reported_price_includes_fees":false,"reported_price":0.0,"reported_fees":0.0,"used":23,"waitlist_count":0,"attendee_count":23,"discount_code":"","reported_original_price":0.0}];
    Globals.eventInfo.payment_methods = [];
    Globals.eventInfo.currency = "USD";
    Globals.eventInfo.startDate = "2025-10-24T14:30:00Z";
    Globals.eventInfo.endDate = "2025-10-24T21:30:00Z";
    Globals.eventInfo.title = "Oslo After Work Social";
    Globals.eventInfo.location = "Oslo, Oslo, Oslo, 0157";
    Globals.eventInfo.description = "Team\u002725 Europe in Barcelona will be packed with exciting announcements, product news, and inspiration for Atlassian user...";
    Globals.supportGuestRegistration = false;
    
        Globals.eventInfo.audienceType = 'IN_PERSON',
        Globals.eventInfo.virtualEvent = false;
    
    Globals.eventInfo.timezoneAbbreviation = 'CEST';

    
        
            Globals.eventInfo.url = '/events/details/atlassian-oslo-presents-oslo-after-work-social/';
...
<script id="event_tags" type="application/json">["Team '25"]</script>
...
<ul class="nav navbar-nav navbar-right top-nav-dragon"><li class="navbar-menu  active-page"><a href="/events/" class="None"   >
    ...
    <script type="application/ld+json">{"@context": "https://schema.org", "@type": "Event", "name": "Oslo After Work Social", "startDate": "2025-10-24T16:30:00+02:00", "endDate": "2025-10-24T23:30:00+02:00", "description": "Team'25 Europe in Barcelona will be packed with exciting announcements, product news, and inspiration for Atlassian user...", "organizer": {"@type": "Organization", "name": "Atlassian Community Events", "url": "https://ace.atlassian.com"}, "location": {"@type": "Place", "name": "Oslo", "address": {"@type": "PostalAddress", "streetAddress": "Oslo", "addressLocality": "Oslo", "postalCode": "0157", "addressRegion": "", "addressCountry": "US"}}, "eventStatus": "https://schema.org/EventScheduled", "eventAttendanceMode": "https://schema.org/OfflineEventAttendanceMode", "image": ["https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/events/blob_Vlhh5iC"], "offers": {"@type": "Offer", "url": "https://ace.atlassian.com/events/details/atlassian-oslo-presents-oslo-after-work-social/", "availability": "http://schema.org/LimitedAvailability", "validFrom": "2025-09-22T12:49:01Z", "validThrough": "2025-10-24T21:30:00Z", "price": 0}}</script>
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><li class="people-card general-card" data-testid="organizer-card"><div style="background-image:url(https://res.cloudinary.com/startup-grind/image/upload/c_fill,w_250,h_250,g_center/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/avatars/paulo_ramalho.png);border-radius:50%;width:175px;height:175px;background-size:cover" role="img" aria-label="Paulo Ramalho avatar"></div><div class="People-styles-info-D3x35"><h2 class="Text-Text__h2_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__h2_2lnce" dir="auto">Paulo<!-- --> <!-- -->Ramalho</h2><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Sopra Steria</p><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Atlassian Senior Solutions Architect</p></div><div><a class="Button-styles__button_iwr8t Button-styles__link_iwr8t Button-styles__medium_iwr8t Button-styles__outlined_iwr8t Button-styles__standard_iwr8t" aria-label="See Paulo Ramalho&#x27;s bio" href="/u/mcnk7h/" rel="noopener">See bio</a></div></li></div><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><li class="people-card general-card" data-testid="organizer-card"><div style="background-image:url(https://res.cloudinary.com/startup-grind/image/upload/c_fill,w_250,h_250,g_center/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/featured_attendees/moi.jpg);border-radius:50%;width:175px;height:175px;background-size:cover" role="img" aria-label="Dag Atle Stenstad avatar"></div><div class="People-styles-info-D3x35"><h2 class="Text-Text__h2_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__h2_2lnce" dir="auto">Dag Atle<!-- --> <!-- -->Stenstad</h2><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Fremtind Forsikring AS</p><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Teamlead</p></div><div><a class="Button-styles__button_iwr8t Button-styles__link_iwr8t Button-styles__medium_iwr8t Button-styles__outlined_iwr8t Button-styles__standard_iwr8t" aria-label="See Dag Atle Stenstad&#x27;s bio" href="/u/mwud5r/" rel="noopener">See bio</a></div></li></div><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
<script>
  Globals.forum_uuid = "events.event.11351";
  
  
</script>

  <div id="react-topic-create" data-forum-uuid="events.event.11351" class="pull-right"></div>
    ...
    <div class="modal-dialog contact-host" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="contact-host container" method="post" chapterid="249" eventid="11351">
                    <input type="hidden" name="csrfmiddlewaretoken" value="qmsVZrNe97mcXPNjX9klxAedWmFjXHNao4xzRLdB7xROUnGCtMb9lJj2VyfUAWWU">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row message-row">
                    <p class="not-ready-message">This event will start on Oct 24, 4:30 PM (CEST) </p>
