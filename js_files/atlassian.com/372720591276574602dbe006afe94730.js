<!doctype html>
    ...
    <head>
        ...
        <link rel="canonical" href="https://ace.atlassian.com/events/details/atlassian-reston-presents-how-agencies-are-saving-big-and-serving-better/rollbar.js">

        <title>See How Agencies are Saving Big and Serving Better at Atlassian Community Events Reston
</title>
        <meta name="keywords" content="">
        <meta name="description" content="Atlassian Community Events Reston presents How Agencies are Saving Big and Serving Better | Oct 14, 2025. Find event and ticket information.
">
...
<meta name="twitter:title" content="How Agencies are Saving Big and Serving Better" />

    <meta name="twitter:description" content="Virtual Event - Government agencies are constantly striving to deliver better services while reducing costs and dismantling silos. Join ..." />


<meta name="twitter:image" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/events/blob_fRZA46Y" />
        ...
        <meta property="og:image" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/events/blob_fRZA46Y" />
        <meta property="og:image:secure_url" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/events/blob_fRZA46Y" />
        <meta property="og:image:width" content="1080" />
        <meta property="og:image:height" content="1080" />
    

        <meta property="og:title" content="How Agencies are Saving Big and Serving Better | Atlassian Community Events" />
        <meta property="og:description" content="Virtual Event - Government agencies are constantly striving to deliver better services while reducing costs and dismantling silos. Join ..."/>
        <meta property="og:url" content="https://ace.atlassian.com/events/details/atlassian-reston-presents-how-agencies-are-saving-big-and-serving-better/rollbar.js" />
...
<meta property="og:locale" content="en_US" />
    ...
    <meta property="event:start_time" content="Oct 14, 2025, 1:00 PM (EDT)" />
    
    <meta property="event:end_time" content="Oct 14, 2025, 2:00 PM (EDT)" />

<meta property="event:attending_count" content="8" />
<meta property="event:ticket_uri" content="https://ace.atlassian.com/events/details/atlassian-reston-presents-how-agencies-are-saving-big-and-serving-better/#/purchase" />
...
<meta name="twitter:label1" value="Where" />
    ...
    <meta name="twitter:data1" value="Virtual Event - https://ace.atlassian.com/events/details/atlassian-reston-presents-how-agencies-are-saving-big-and-serving-better/rollbar.js" />

<meta name="twitter:label2" value="When" />

    
    <meta name="twitter:data2" value="Oct 14, 2025, 1:00 PM (EDT)" />
...
<link rel="stylesheet" href="/static/js/ticketwidget.css?v=4ca06c5bf69ab349c7b9499eeea78592081ea99e">
        ...
        <script>
            ...
            Globals.signup_url                  = '/signup/?next=/events/details/atlassian-reston-presents-how-agencies-are-saving-big-and-serving-better/rollbar.js';
            Globals.login_url                   = '/accounts/login/?next=/events/details/atlassian-reston-presents-how-agencies-are-saving-big-and-serving-better/rollbar.js';
            Globals.logout_url                  = '/accounts/logout/?next=/events/details/atlassian-reston-presents-how-agencies-are-saving-big-and-serving-better/rollbar.js';
            ...
            Globals.global_attendee_index       = 'Iw2CHv8Tgpw3aU7yHTYfGZtEbmBZ1v39VKQLhv2FkPBcXQaR2J4aoiw9LJcwymSv';
...
Globals.eventInfo = {
    ...
    Globals.slug = 'atlassian-reston-presents-how-agencies-are-saving-big-and-serving-better';
    Globals.rsvp_only = true;
    Globals.absoluteURL = 'https://ace.atlassian.com/events/details/atlassian-reston-presents-how-agencies-are-saving-big-and-serving-better/rollbar.js';
    Globals.socialShareText = 'I\u0027m attending {site_title} {chapter_title} w/ {event_title} on {event_start_date}.{event_static_url}';
    Globals.staticURL = 'https://ace.atlassian.com/e/mrfxes/';
    Globals.twitterHandle = '@atlassian';
    Globals.hideFeeColumn = false;
    Globals.twitterWithFallback = 'How Agencies are Saving Big and Serving Better';
    Globals.companyHashtag = '#AtlassianCommunity';
    Globals.twitterCompanyWithFallback = '';
    Globals.cityName = 'Reston';
    Globals.chapterSlug = 'reston';
    Globals.chapterId = 508;
    Globals.eventDate = 'Oct 14, 2025';
    Globals.eventDateTime = 'Oct 14, 1:00 PM';
    
        Globals.eventInfo.minutesUntilStart = 5906;
        Globals.eventInfo.minutesUntilStartTimer = 5906;
    
    Globals.eventInfo.tickets = [{"id":10769,"event":11278,"title":"General Admission","audience_type":"VIRTUAL","description":"","access_code":"","visible":true,"price":0.0,"fees":0.0,"total_price":0.0,"available":1,"total_count":1000,"sale_start_date":"2025-09-09T11:03:20-04:00","sale_start_date_naive":"2025-09-09T11:03:20","sale_start_date_derived_from_event_publish":true,"sale_end_date":"2025-10-14T14:00:00-04:00","sale_end_date_naive":"2025-10-14T14:00:00","sale_end_date_derived_from_event_end":true,"min_per_order":0,"max_per_order":1,"is_for_sale":true,"can_delete":false,"currency":"USD","waitlist_enabled":false,"reported_price_includes_fees":false,"reported_price":0.0,"reported_fees":0.0,"used":7,"waitlist_count":0,"attendee_count":7,"discount_code":"","reported_original_price":0.0}];
    Globals.eventInfo.payment_methods = [];
    Globals.eventInfo.currency = "USD";
    Globals.eventInfo.startDate = "2025-10-14T17:00:00Z";
    Globals.eventInfo.endDate = "2025-10-14T18:00:00Z";
    Globals.eventInfo.title = "How Agencies are Saving Big and Serving Better";
    Globals.eventInfo.location = "";
    Globals.eventInfo.description = "Government agencies are constantly striving to deliver better services while reducing costs and dismantling silos. Join ...";
    ...
    Globals.eventInfo.timezoneAbbreviation = 'EDT';
            ...
            Globals.eventInfo.url = '/events/details/atlassian-reston-presents-how-agencies-are-saving-big-and-serving-better/';
...
<script id="event_tags" type="application/json">["Jira Service Management", "Live Learning", "Ways of Working"]</script>
...
<ul class="nav navbar-nav navbar-right top-nav-dragon"><li class="navbar-menu  active-page"><a href="/events/" class="None"   >
    ...
    <script type="application/ld+json">{"@context": "https://schema.org", "@type": "Event", "name": "How Agencies are Saving Big and Serving Better", "startDate": "2025-10-14T13:00:00-04:00", "endDate": "2025-10-14T14:00:00-04:00", "description": "Government agencies are constantly striving to deliver better services while reducing costs and dismantling silos. Join ...", "organizer": {"@type": "Organization", "name": "Atlassian Community Events", "url": "https://ace.atlassian.com"}, "location": {"@type": "VirtualLocation", "url": "https://ace.atlassian.com/e/mrfxes/"}, "eventStatus": "https://schema.org/EventScheduled", "eventAttendanceMode": "https://schema.org/OnlineEventAttendanceMode", "image": ["https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/events/blob_fRZA46Y"], "offers": {"@type": "Offer", "url": "https://ace.atlassian.com/events/details/atlassian-reston-presents-how-agencies-are-saving-big-and-serving-better/", "availability": "http://schema.org/LimitedAvailability", "validFrom": "2025-09-09T15:03:20Z", "validThrough": "2025-10-14T18:00:00Z", "price": 0}, "performer": [{"@type": "Person", "name": "Cameron Starman", "image": "https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/events/Cameron%20Professional%20Head%20Shot_AHxzQKy.jpg"}, {"@type": "Person", "name": "Derek Neal", "image": "https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/events/blob_RKFLXrH"}, {"@type": "Person", "name": "Cynthia Bowles", "image": "https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/events/blob_Pb75zMG"}]}</script>
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><li class="people-card general-card" data-testid="speaker-card"><div style="background-image:url(https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2,f_auto,g_face,h_400,q_auto:good,w_400/v1/gcs/platform-data-atlassian/events/Cameron%2520Professional%2520Head%2520Shot_AHxzQKy.jpg);border-radius:50%;width:175px;height:175px;background-size:cover" role="img" aria-label="Cameron Starman avatar"></div><div class="People-styles-info-D3x35"><h2 class="Text-Text__h2_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__h2_2lnce" dir="auto">Cameron<!-- --> <!-- -->Starman</h2><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Clovity</p><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Senior Director, Client Management</p></div><div><button class="Button-styles__button_iwr8t Button-styles__medium_iwr8t Button-styles__outlined_iwr8t Button-styles__standard_iwr8t" aria-label="See Cameron Starman&#x27;s bio" dir="auto" type="submit">See bio</button></div></li></div><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><li class="people-card general-card" data-testid="speaker-card"><div style="background-image:url(https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2,f_auto,g_face,h_200,q_auto:good,w_200/v1/gcs/platform-data-atlassian/events/blob_RKFLXrH);border-radius:50%;width:175px;height:175px;background-size:cover" role="img" aria-label="Derek Neal avatar"></div><div class="People-styles-info-D3x35"><h2 class="Text-Text__h2_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__h2_2lnce" dir="auto">Derek<!-- --> <!-- -->Neal</h2><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Atlassian</p><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Head of Service Management for North America Public Sector</p></div><div><button class="Button-styles__button_iwr8t Button-styles__medium_iwr8t Button-styles__outlined_iwr8t Button-styles__standard_iwr8t" aria-label="See Derek Neal&#x27;s bio" dir="auto" type="submit">See bio</button></div></li></div><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><li class="people-card general-card" data-testid="organizer-card"><div style="background-image:url(https://res.cloudinary.com/startup-grind/image/upload/c_fill,w_250,h_250,g_center/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/avatars/jack_saslowsky_t8NzBY8.jpg);border-radius:50%;width:175px;height:175px;background-size:cover" role="img" aria-label="Jack Saslowsky avatar"></div><div class="People-styles-info-D3x35"><h2 class="Text-Text__h2_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__h2_2lnce" dir="auto">Jack<!-- --> <!-- -->Saslowsky</h2><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Carahsoft</p><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Marketing Team Lead</p></div><div><a class="Button-styles__button_iwr8t Button-styles__link_iwr8t Button-styles__medium_iwr8t Button-styles__outlined_iwr8t Button-styles__standard_iwr8t" aria-label="See Jack Saslowsky&#x27;s bio" href="/u/m6f3f3/" rel="noopener">See bio</a></div></li></div><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><li class="people-card general-card" data-testid="organizer-card"><div style="background-image:url(https://res.cloudinary.com/startup-grind/image/upload/c_fill,w_250,h_250,g_center/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/avatars/mckenzie_nieman.jpg);border-radius:50%;width:175px;height:175px;background-size:cover" role="img" aria-label="McKenzie Nieman avatar"></div><div class="People-styles-info-D3x35"><h2 class="Text-Text__h2_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__h2_2lnce" dir="auto">McKenzie<!-- --> <!-- -->Nieman</h2><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Carahsoft</p></div><div><a class="Button-styles__button_iwr8t Button-styles__link_iwr8t Button-styles__medium_iwr8t Button-styles__outlined_iwr8t Button-styles__standard_iwr8t" aria-label="See McKenzie Nieman&#x27;s bio" href="/u/m698rp/" rel="noopener">See bio</a></div></li></div><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
<script>
  Globals.forum_uuid = "events.event.11278";
  
  
</script>

  <div id="react-topic-create" data-forum-uuid="events.event.11278" class="pull-right"></div>
    ...
    <div class="modal-dialog contact-host" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="contact-host container" method="post" chapterid="508" eventid="11278">
                    <input type="hidden" name="csrfmiddlewaretoken" value="Tcymygm1fICqFAsekFaV2CCumidVaQjG6qmv8ggNj8HzswvxFvgQKVFZWFOsHH82">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row message-row">
                    <p class="not-ready-message">This event will start on Oct 14, 1:00 PM (EDT) </p>
