<!doctype html>
    ...
    <head>
        ...
        <link rel="canonical" href="https://ace.atlassian.com/events/details/atlassian-chicago-presents-live-from-chicago-its-atlassian-launch-night/rollbar.js">

        <title>See Live from Chicago, it's Atlassian Launch Night! at Atlassian Community Events Chicago
</title>
        <meta name="keywords" content="">
        <meta name="description" content="Atlassian Community Events Chicago presents Live from Chicago, it&#x27;s Atlassian Launch Night! | Oct 25, 2011. Find event and ticket information.
">
...
<meta name="twitter:title" content="Live from Chicago, it&#x27;s Atlassian Launch Night!" />
...
<meta name="twitter:image" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/event_banners/CSD-1081_Community_BevyBanner_FY23_Circles_R2a-01.png" />
        ...
        <meta property="og:title" content="Live from Chicago, it&#x27;s Atlassian Launch Night! | Atlassian Community Events" />
        <meta property="og:description" content="In-person Event - None"/>
        <meta property="og:url" content="https://ace.atlassian.com/events/details/atlassian-chicago-presents-live-from-chicago-its-atlassian-launch-night/rollbar.js" />
...
<meta property="og:locale" content="en_US" />
    ...
    <meta property="event:start_time" content="Oct 25, 2011, 2:30 PM (CDT)" />
    
    <meta property="event:end_time" content="Oct 25, 2011, 4:30 PM (CDT)" />

<meta property="event:attending_count" content="0" />
<meta property="event:ticket_uri" content="https://ace.atlassian.com/events/details/atlassian-chicago-presents-live-from-chicago-its-atlassian-launch-night/#/purchase" />
...
<meta name="twitter:label1" value="Where" />
    ...
    <meta name="twitter:data1" value="In-person Event - TechNexus - Illinois Technology Association Building 200 S. Wacker Drive, 15th Floor, Conference Roo -  Chicago 60290" />

<meta name="twitter:label2" value="When" />

    
    <meta name="twitter:data2" value="Oct 25, 2011, 2:30 PM (CDT)" />
    ...
    <script>
        ...
        <script>
            ...
            Globals.signup_url                  = '/signup/?next=/events/details/atlassian-chicago-presents-live-from-chicago-its-atlassian-launch-night/rollbar.js';
            Globals.login_url                   = '/accounts/login/?next=/events/details/atlassian-chicago-presents-live-from-chicago-its-atlassian-launch-night/rollbar.js';
            Globals.logout_url                  = '/accounts/logout/?next=/events/details/atlassian-chicago-presents-live-from-chicago-its-atlassian-launch-night/rollbar.js';
            ...
            Globals.global_search_key              = '';
            ...
            Globals.global_attendee_index       = 'EFn1RPzxDIUoCQcEysKWpvBY8NuHUm5da2WQBoXX7PxMTLSASpBNMUh1tDkZEW8l';
...
<ul class="nav navbar-nav navbar-right top-nav-dragon"><li class="navbar-menu  active-page"><a href="/events/" class="None"   >
    ...
    <script type="application/ld+json">{"@context": "https://schema.org", "@type": "Event", "name": "Live from Chicago, it's Atlassian Launch Night!", "startDate": "2011-10-25T14:30:00-05:00", "endDate": "2011-10-25T16:30:00-05:00", "description": null, "organizer": {"@type": "Organization", "name": "Atlassian Community Events", "url": "https://ace.atlassian.com"}, "location": {"@type": "Place", "name": "TechNexus - Illinois Technology Association Building 200 S. Wacker Drive, 15th Floor, Conference Roo", "address": {"@type": "PostalAddress", "streetAddress": "", "addressLocality": "Chicago", "postalCode": "60290", "addressRegion": "IL", "addressCountry": "US"}}, "eventStatus": "https://schema.org/EventScheduled", "eventAttendanceMode": "https://schema.org/OfflineEventAttendanceMode", "offers": {"@type": "Offer", "url": "https://ace.atlassian.com/events/details/atlassian-chicago-presents-live-from-chicago-its-atlassian-launch-night/", "availability": "http://schema.org/LimitedAvailability", "validFrom": "2011-10-25T19:30:00Z", "validThrough": "2011-10-25T21:30:00Z", "price": 0}}</script>
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><li class="people-card general-card" data-testid="organizer-card"><div style="background-image:url(https://res.cloudinary.com/startup-grind/image/upload/c_fill,w_250,h_250,g_center/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/avatars/peter_dewitt_9O0kTHz.jpeg);border-radius:50%;width:175px;height:175px;background-size:cover" role="img" aria-label="Peter DeWitt avatar"></div><div class="People-styles-info-D3x35"><h2 class="Text-Text__h2_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__h2_2lnce" dir="auto">Peter<!-- --> <!-- -->DeWitt</h2><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Manager, Application Administration</p></div><div><a class="Button-styles__button_iwr8t Button-styles__link_iwr8t Button-styles__medium_iwr8t Button-styles__outlined_iwr8t Button-styles__standard_iwr8t" aria-label="See Peter DeWitt&#x27;s bio" href="/u/mwgtxm/" rel="noopener">See bio</a></div></li></div><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><li class="people-card general-card" data-testid="organizer-card"><div style="background-image:url(https://res.cloudinary.com/startup-grind/image/fetch/c_fill,w_250,h_250,g_center/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/https://avatar-cdn.atlassian.com/c02b6018193a83e34ad74bd541125d7d%3Fd%3DNone%26s%3D800);border-radius:50%;width:175px;height:175px;background-size:cover" role="img" aria-label="Greg Koeberl avatar"></div><div class="People-styles-info-D3x35"><h2 class="Text-Text__h2_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__h2_2lnce" dir="auto">Greg<!-- --> <!-- -->Koeberl</h2><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Director of Business Development</p></div><div><a class="Button-styles__button_iwr8t Button-styles__link_iwr8t Button-styles__medium_iwr8t Button-styles__outlined_iwr8t Button-styles__standard_iwr8t" aria-label="See Greg Koeberl&#x27;s bio" href="/u/m72ake/" rel="noopener">See bio</a></div></li></div><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
<script>
  Globals.forum_uuid = "events.event.1033";
  
  
</script>

  <div id="react-topic-create" data-forum-uuid="events.event.1033" class="pull-right"></div>
    ...
    <div class="modal-dialog contact-host" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="contact-host container" method="post" chapterid="15" eventid="1033">
                    <input type="hidden" name="csrfmiddlewaretoken" value="WvsCtVDB8Zwga3PO23b8KtYABNBmjiuWsS1rdu11C69ErYvKm02Z7SEDWDrE3Sx4">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row message-row">
                    <p class="not-ready-message">This event will start on Oct 25, 2:30 PM (CDT) </p>
