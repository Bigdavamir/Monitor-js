<!doctype html>
    ...
    <head>
        ...
        <link rel="canonical" href="https://ace.atlassian.com/events/details/atlassian-boise-presents-community-social-good-riddance-erica/rollbar.js">

        <title>See Community Social: Good Riddance Erica at Atlassian Community Events Boise
</title>
        <meta name="keywords" content="">
        <meta name="description" content="Atlassian Community Events Boise presents Community Social: Good Riddance Erica | Oct 14, 2025. Find event and ticket information.
">
...
<meta name="twitter:title" content="Community Social: Good Riddance Erica" />

    <meta name="twitter:description" content="In-person Event - Join us for a special community gathering to bid farewell to Erica, our esteemed champion &amp; leader, as she passes the ba..." />


<meta name="twitter:image" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/event_banners/CSD-1081_Community_BevyBanner_FY23_Circles_R2a-01.png" />
        ...
        <meta property="og:image" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/event_banners/CSD-1081_Community_BevyBanner_FY23_Circles_R2a-01.png" />
        <meta property="og:image:secure_url" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/event_banners/CSD-1081_Community_BevyBanner_FY23_Circles_R2a-01.png" />
        <meta property="og:image:width" content="1080" />
        <meta property="og:image:height" content="1080" />
    

        <meta property="og:title" content="Community Social: Good Riddance Erica | Atlassian Community Events" />
        <meta property="og:description" content="In-person Event - Join us for a special community gathering to bid farewell to Erica, our esteemed champion &amp; leader, as she passes the ba..."/>
        <meta property="og:url" content="https://ace.atlassian.com/events/details/atlassian-boise-presents-community-social-good-riddance-erica/rollbar.js" />
...
<meta property="og:locale" content="en_US" />
    ...
    <meta property="event:start_time" content="Oct 14, 2025, 4:30 PM (MDT)" />
    
    <meta property="event:end_time" content="Oct 14, 2025, 6:00 PM (MDT)" />

<meta property="event:attending_count" content="11" />
<meta property="event:ticket_uri" content="https://ace.atlassian.com/events/details/atlassian-boise-presents-community-social-good-riddance-erica/#/purchase" />
...
<meta name="twitter:label1" value="Where" />
    ...
    <meta name="twitter:data1" value="In-person Event - Barbarian Brewing- Garden City - 114 East 32nd Street Garden City 83714" />

<meta name="twitter:label2" value="When" />

    
    <meta name="twitter:data2" value="Oct 14, 2025, 4:30 PM (MDT)" />
...
<link rel="stylesheet" href="/static/js/ticketwidget.css?v=4ca06c5bf69ab349c7b9499eeea78592081ea99e">
        ...
        <script>
            ...
            Globals.signup_url                  = '/signup/?next=/events/details/atlassian-boise-presents-community-social-good-riddance-erica/rollbar.js';
            Globals.login_url                   = '/accounts/login/?next=/events/details/atlassian-boise-presents-community-social-good-riddance-erica/rollbar.js';
            Globals.logout_url                  = '/accounts/logout/?next=/events/details/atlassian-boise-presents-community-social-good-riddance-erica/rollbar.js';
            ...
            Globals.global_attendee_index       = 'Lc2B06J4o00btG7qVWOd97lSjybvFwlTFtix8HCP4J5pTtfAZQhBbwuuNqVoideg';
...
Globals.eventInfo = {
    ...
    Globals.slug = 'atlassian-boise-presents-community-social-good-riddance-erica';
    Globals.rsvp_only = true;
    Globals.absoluteURL = 'https://ace.atlassian.com/events/details/atlassian-boise-presents-community-social-good-riddance-erica/rollbar.js';
    Globals.socialShareText = 'I\u0027m attending {site_title} {chapter_title} w/ {event_title} on {event_start_date}.{event_static_url}';
    Globals.staticURL = 'https://ace.atlassian.com/e/mpvyp3/';
    Globals.twitterHandle = '@atlassian';
    Globals.hideFeeColumn = false;
    Globals.twitterWithFallback = 'Community Social: Good Riddance Erica';
    Globals.companyHashtag = '#AtlassianCommunity';
    Globals.twitterCompanyWithFallback = '';
    Globals.cityName = 'Boise';
    Globals.chapterSlug = 'boise';
    Globals.chapterId = 189;
    Globals.eventDate = 'Oct 14, 2025';
    Globals.eventDateTime = 'Oct 14, 4:30 PM';
    
        Globals.eventInfo.minutesUntilStart = 6236;
        Globals.eventInfo.minutesUntilStartTimer = 6236;
    
    Globals.eventInfo.tickets = [{"id":10618,"event":11129,"title":"In-Person Ticket","audience_type":"IN_PERSON","description":"","access_code":"","visible":true,"price":0.0,"fees":0.0,"total_price":0.0,"available":0,"total_count":50,"sale_start_date":"2025-08-19T19:04:53-06:00","sale_start_date_naive":"2025-08-19T19:04:53","sale_start_date_derived_from_event_publish":true,"sale_end_date":"2025-10-14T18:00:00-06:00","sale_end_date_naive":"2025-10-14T18:00:00","sale_end_date_derived_from_event_end":true,"min_per_order":0,"max_per_order":0,"is_for_sale":true,"can_delete":false,"currency":"USD","waitlist_enabled":false,"reported_price_includes_fees":false,"reported_price":0.0,"reported_fees":0.0,"used":11,"waitlist_count":0,"attendee_count":11,"discount_code":"","reported_original_price":0.0}];
    Globals.eventInfo.payment_methods = [];
    Globals.eventInfo.currency = "USD";
    Globals.eventInfo.startDate = "2025-10-14T22:30:00Z";
    Globals.eventInfo.endDate = "2025-10-15T00:00:00Z";
    Globals.eventInfo.title = "Community Social: Good Riddance Erica";
    Globals.eventInfo.location = "Barbarian Brewing\u002D Garden City, 114 East 32nd Street, Garden City, 83714";
    Globals.eventInfo.description = "Join us for a special community gathering to bid farewell to Erica, our esteemed champion \u0026 leader, as she passes the ba...";
    Globals.supportGuestRegistration = false;
    
        Globals.eventInfo.audienceType = 'IN_PERSON',
        Globals.eventInfo.virtualEvent = false;
    
    Globals.eventInfo.timezoneAbbreviation = 'MDT';

    
        
            Globals.eventInfo.url = '/events/details/atlassian-boise-presents-community-social-good-riddance-erica/';
...
<script id="event_tags" type="application/json">["Community"]</script>
...
<ul class="nav navbar-nav navbar-right top-nav-dragon"><li class="navbar-menu  active-page"><a href="/events/" class="None"   >
    ...
    <script type="application/ld+json">{"@context": "https://schema.org", "@type": "Event", "name": "Community Social: Good Riddance Erica", "startDate": "2025-10-14T16:30:00-06:00", "endDate": "2025-10-14T18:00:00-06:00", "description": "Join us for a special community gathering to bid farewell to Erica, our esteemed champion \u0026 leader, as she passes the ba...", "organizer": {"@type": "Organization", "name": "Atlassian Community Events", "url": "https://ace.atlassian.com"}, "location": {"@type": "Place", "name": "Barbarian Brewing- Garden City", "address": {"@type": "PostalAddress", "streetAddress": "114 East 32nd Street", "addressLocality": "Garden City", "postalCode": "83714", "addressRegion": "", "addressCountry": "US"}}, "eventStatus": "https://schema.org/EventScheduled", "eventAttendanceMode": "https://schema.org/OfflineEventAttendanceMode", "offers": {"@type": "Offer", "url": "https://ace.atlassian.com/events/details/atlassian-boise-presents-community-social-good-riddance-erica/", "availability": "http://schema.org/LimitedAvailability", "validFrom": "2025-08-20T01:04:53Z", "validThrough": "2025-10-15T00:00:00Z", "price": 0}}</script>
...
<script>
  Globals.forum_uuid = "events.event.11129";
  
  
</script>

  <div id="react-topic-create" data-forum-uuid="events.event.11129" class="pull-right"></div>
    ...
    <div class="modal-dialog contact-host" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="contact-host container" method="post" chapterid="189" eventid="11129">
                    <input type="hidden" name="csrfmiddlewaretoken" value="cIoIQDsB7zvgf32AlULSVcS02MSsxD8D6ZEEYelmNiAuFQaKpOegXB1CwEClak10">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row message-row">
                    <p class="not-ready-message">This event will start on Oct 14, 4:30 PM (MDT) </p>
