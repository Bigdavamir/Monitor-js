...
Confluence.Templates.CQLSearch.searchResult = function(opt_data, opt_ignored) {
  var output = '<h3>' + aui.icons.icon({icon: '', useIconFont: true, extraClasses: opt_data.iconCssClass, extraAttributes: {tabindex: '0', 'aria-label': AJS.format('{0} icon for search result',opt_data.entityType)}}) + ((opt_data.content) ? '<a class="search-result-link visitable" href="' + soy.$$escapeHtml("" + opt_data.url) + '" data-type="' + soy.$$escapeHtml(opt_data.content.type) + '">' + soy.$$filterNoAutoescape(opt_data.title) + '</a>' + ((opt_data.pageScore) ? ' [' + soy.$$escapeHtml(opt_data.pageScore) + '] ' : '') : '<a class="search-result-link visitable" href="' + soy.$$escapeHtml("" + opt_data.url) + '" data-type="' + soy.$$escapeHtml(opt_data.entityType) + '">' + soy.$$filterNoAutoescape(opt_data.title) + '</a>' + ((opt_data.pageScore) ? ' [' + soy.$$escapeHtml(opt_data.pageScore) + '] ' : '')) + '</h3><div class="highlights">' + soy.$$filterNoAutoescape(opt_data.excerpt) + '</div><div class="search-result-meta">';
  if (opt_data.breadcrumbs && opt_data.breadcrumbs.length > 0) {
    var breadcrumbList59 = opt_data.breadcrumbs;
    var breadcrumbListLen59 = breadcrumbList59.length;
    for (var breadcrumbIndex59 = 0; breadcrumbIndex59 < breadcrumbListLen59; breadcrumbIndex59++) {
      var breadcrumbData59 = breadcrumbList59[breadcrumbIndex59];
      output += '<a class="container" href="' + soy.$$escapeHtml("" + breadcrumbData59.url) + '" title="' + soy.$$escapeHtml(breadcrumbData59.label) + '">' + soy.$$escapeHtml(breadcrumbData59.label) + '</a>' + ((! (breadcrumbIndex59 == breadcrumbListLen59 - 1)) ? '<span>' + soy.$$escapeHtml(breadcrumbData59.separator) + '</span>' : '');
    }
  } else {
    output += (opt_data.resultGlobalContainer) ? '<a class="container" href="' + soy.$$escapeHtml("" + opt_data.resultGlobalContainer.displayUrl) + '" title="' + soy.$$escapeHtml('Space') + '">' + soy.$$escapeHtml(opt_data.resultGlobalContainer.title) + '</a>' + ((opt_data.resultParentContainer) ? '<span> / &#8230; / </span><a class="container" href="' + soy.$$escapeHtml("" + opt_data.resultParentContainer.displayUrl) + '" title="' + soy.$$escapeHtml('Page') + '">' + soy.$$escapeHtml(opt_data.resultParentContainer.title) + '</a>' : '') : '';
  }
...
Confluence.Templates.CQLSearch.noSearchResults = function(opt_data, opt_ignored) {
  ...
  if (opt_data.queryString == null) {
    ...
    var sanitizedSearchParam__soy108 = '' + soy.$$escapeHtml(opt_data.queryString);
    output += soy.$$filterNoAutoescape(AJS.format('No results found for \x3cstrong\x3e{0}\x3c/strong\x3e. Please try one of the following suggestions:',sanitizedSearchParam__soy108));
  }
  output += '<ul>' + ((opt_data.archivedResultsCount) ? (opt_data.archivedResultsCount > 0) ? '<li>' + soy.$$filterNoAutoescape(AJS.format('There were \x3cstrong\x3e{0}\x3c/strong\x3e results found in \x3cem\x3earchived spaces\x3c/em\x3e. Enable the option in advanced search tools to see these results.',opt_data.archivedResultsCount)) + '</li>' : '' : '') + '<li>' + soy.$$filterNoAutoescape(AJS.format('Use more general search terms or \x3ca href\x3d\x22{0}\x22\x3econsult the online documentation\x3c/a\x3e for tips.','https://confluence.atlassian.com/display/DOC/Confluence+Search+Syntax')) + '</li><li>' + soy.$$escapeHtml('If you are filtering by space, content, last modification date or contributor, try removing or adjusting the filter') + '</li></ul><ul class="search-results" data-query="' + soy.$$escapeHtml(opt_data.queryString) + '"></ul>';
  return output;
};
if (goog.DEBUG) {
...
Confluence.Templates.CQLSearch.searchMissingQuery = function(opt_data, opt_ignored) {
  return '<h2 class="search-missing-query-header">' + soy.$$escapeHtml('Search for pages, files, people and more') + '</h2><p class="search-missing-query-body"><span id="search-missing-query-body-label" class="search-missing-query-body-label">' + soy.$$escapeHtml('Refine your search using the filters on the left, or use syntax to create an advanced query.') + '</span><br/><a class="search-missing-query-body-link" href="' + soy.$$escapeHtml("https://docs.atlassian.com/confluence/docs-92/Search") + '" target="_blank">' + soy.$$escapeHtml('Learn more') + '</a></p>';
};
if (goog.DEBUG) {
...
define('confluence-search/view/search', [
    ...
    return Backbone.View.extend({
        ...
        showHelpDialog: function () {
            ...
            dialog.addHeader("Search Help");
            dialog.addPanel("General", Templates.Help.general());
            dialog.get("panel:0");
            dialog.addPanel("Wildcards", Templates.Help.wildcards());
            dialog.addPanel("Macros", Templates.Help.macros());
            dialog.addPanel("Other", Templates.Help.other());
...
define('confluence-search/view/cql-filter', [
    ...
    'underscore',
    'confluence/meta',
    'confluence-search/analytics-search-filters'
], function(
    searchUtils,
    filter,
    $,
    ...
    return filter.extend({
        ...
        getParams: function () {
            ...
            analytics.triggerAdvancedSearchStartedEvent(this.cqlComponent.fieldArrays);
...
;
try {
/* module-key = 'com.atlassian.confluence.plugins.search.confluence-search:confluence-search-resources', location = '/js/analytics-search-filters.js' */
