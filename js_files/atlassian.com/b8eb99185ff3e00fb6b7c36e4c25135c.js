<!doctype html>
    ...
    <head>
        ...
        <link rel="canonical" href="https://ace.atlassian.com/events/details/atlassian-vancouver-presents-live-from-vancouver-its-atlassian-launch-night/rollbar.js">

        <title>See Live from Vancouver, it's Atlassian Launch Night! at Atlassian Community Events Vancouver
</title>
        <meta name="keywords" content="">
        <meta name="description" content="Atlassian Community Events Vancouver presents Live from Vancouver, it&#x27;s Atlassian Launch Night! | Oct 25, 2011. Find event and ticket information.
">
...
<meta name="twitter:title" content="Live from Vancouver, it&#x27;s Atlassian Launch Night!" />

    <meta name="twitter:description" content="In-person Event - None" />
...
<meta name="twitter:image" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/event_banners/CSD-1081_Community_BevyBanner_FY23_Circles_R2a-01.png" />
        ...
        <meta property="og:title" content="Live from Vancouver, it&#x27;s Atlassian Launch Night! | Atlassian Community Events" />
        <meta property="og:description" content="In-person Event - None"/>
        <meta property="og:url" content="https://ace.atlassian.com/events/details/atlassian-vancouver-presents-live-from-vancouver-its-atlassian-launch-night/rollbar.js" />
...
<meta property="og:locale" content="en_US" />
    ...
    <meta property="event:start_time" content="Oct 25, 2011, 10:30 AM (PDT)" />
    
    <meta property="event:end_time" content="Oct 25, 2011, 1:00 PM (PDT)" />

<meta property="event:attending_count" content="0" />
<meta property="event:ticket_uri" content="https://ace.atlassian.com/events/details/atlassian-vancouver-presents-live-from-vancouver-its-atlassian-launch-night/#/purchase" />
...
<meta name="twitter:label1" value="Where" />
    ...
    <meta name="twitter:data1" value="In-person Event - Vivonet Yaletown Office, 450-1122 Mainland St. -  Vancouver " />

<meta name="twitter:label2" value="When" />

    
    <meta name="twitter:data2" value="Oct 25, 2011, 10:30 AM (PDT)" />
    ...
    <script>
        ...
        <script>
            ...
            Globals.signup_url                  = '/signup/?next=/events/details/atlassian-vancouver-presents-live-from-vancouver-its-atlassian-launch-night/rollbar.js';
            Globals.login_url                   = '/accounts/login/?next=/events/details/atlassian-vancouver-presents-live-from-vancouver-its-atlassian-launch-night/rollbar.js';
            Globals.logout_url                  = '/accounts/logout/?next=/events/details/atlassian-vancouver-presents-live-from-vancouver-its-atlassian-launch-night/rollbar.js';
            ...
            Globals.global_search_key              = '';
            ...
            Globals.global_attendee_index       = 'gsgeTU2zJM6RgdyMg0bTJaAiqrywPQuQyzZ1FXXy4rX4oVQt5RDAmzvrPweKUw5V';
...
Globals.eventInfo = {
    ...
    "agenda_term": 'Agenda',
    "agenda": {"any_descriptions":false,"days":[{"agenda":[],"title":""}],"multiday":false},
...
<ul class="nav navbar-nav navbar-right top-nav-dragon"><li class="navbar-menu  active-page"><a href="/events/" class="None"   >
    ...
    <script type="application/ld+json">{"@context": "https://schema.org", "@type": "Event", "name": "Live from Vancouver, it's Atlassian Launch Night!", "startDate": "2011-10-25T10:30:00-07:00", "endDate": "2011-10-25T13:00:00-07:00", "description": null, "organizer": {"@type": "Organization", "name": "Atlassian Community Events", "url": "https://ace.atlassian.com"}, "location": {"@type": "Place", "name": "Vivonet Yaletown Office, 450-1122 Mainland St.", "address": {"@type": "PostalAddress", "streetAddress": "", "addressLocality": "Vancouver", "postalCode": "", "addressRegion": "BC", "addressCountry": "US"}}, "eventStatus": "https://schema.org/EventScheduled", "eventAttendanceMode": "https://schema.org/OfflineEventAttendanceMode", "offers": {"@type": "Offer", "url": "https://ace.atlassian.com/events/details/atlassian-vancouver-presents-live-from-vancouver-its-atlassian-launch-night/", "availability": "http://schema.org/LimitedAvailability", "validFrom": "2011-10-25T17:30:00Z", "validThrough": "2011-10-25T20:00:00Z", "price": 0}}</script>
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><li class="people-card general-card" data-testid="organizer-card"><div style="background-image:url(https://res.cloudinary.com/startup-grind/image/upload/c_fill,w_250,h_250,g_center/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/avatars/brendan_byers_ii5ScXz.jpg);border-radius:50%;width:175px;height:175px;background-size:cover" role="img" aria-label="Brendan Byers avatar"></div><div class="People-styles-info-D3x35"><h2 class="Text-Text__h2_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__h2_2lnce" dir="auto">Brendan<!-- --> <!-- -->Byers</h2><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Absolute Software</p><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Atlassian User Group Leader</p></div><div><a class="Button-styles__button_iwr8t Button-styles__link_iwr8t Button-styles__medium_iwr8t Button-styles__outlined_iwr8t Button-styles__standard_iwr8t" aria-label="See Brendan Byers&#x27;s bio" href="/u/mjbft6/" rel="noopener">See bio</a></div></li></div><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><li class="people-card general-card" data-testid="organizer-card"><div style="background-image:url(https://res.cloudinary.com/startup-grind/image/upload/c_fill,w_250,h_250,g_center/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/avatars/frieda_tang_pqlWj6o.jpg);border-radius:50%;width:175px;height:175px;background-size:cover" role="img" aria-label="Frieda Tang avatar"></div><div class="People-styles-info-D3x35"><h2 class="Text-Text__h2_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__h2_2lnce" dir="auto">Frieda<!-- --> <!-- -->Tang</h2><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Atlassian User Group Leader</p></div><div><a class="Button-styles__button_iwr8t Button-styles__link_iwr8t Button-styles__medium_iwr8t Button-styles__outlined_iwr8t Button-styles__standard_iwr8t" aria-label="See Frieda Tang&#x27;s bio" href="/u/mbv9cs/" rel="noopener">See bio</a></div></li></div><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><li class="people-card general-card" data-testid="organizer-card"><div style="background-image:url(https://res.cloudinary.com/startup-grind/image/upload/c_fill,w_250,h_250,g_center/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/avatars/arielle_unterberger_samYUbE.jpg);border-radius:50%;width:175px;height:175px;background-size:cover" role="img" aria-label="Arielle Unterberger avatar"></div><div class="People-styles-info-D3x35"><h2 class="Text-Text__h2_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__h2_2lnce" dir="auto">Arielle<!-- --> <!-- -->Unterberger</h2><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Community Leaders</p></div><div><a class="Button-styles__button_iwr8t Button-styles__link_iwr8t Button-styles__medium_iwr8t Button-styles__outlined_iwr8t Button-styles__standard_iwr8t" aria-label="See Arielle Unterberger&#x27;s bio" href="/u/mj4b58/" rel="noopener">See bio</a></div></li></div><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
<script>
  Globals.forum_uuid = "events.event.1015";
  
  
</script>

  <div id="react-topic-create" data-forum-uuid="events.event.1015" class="pull-right"></div>
    ...
    <div class="modal-dialog contact-host" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="contact-host container" method="post" chapterid="158" eventid="1015">
                    <input type="hidden" name="csrfmiddlewaretoken" value="cv3rhppe1FhyFdgGLd3ZCNxroVeDlWGauCMe3skdmk8LNVynA4vGfcsAN0URqChf">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row message-row">
                    <p class="not-ready-message">This event will start on Oct 25, 10:30 AM (PDT) </p>
