<!doctype html>
    ...
    <head>
        ...
        <link rel="canonical" href="https://ace.atlassian.com/events/details/atlassian-tallinn-presents-atlassian-team-25-europe-muljed-ja-uued-ideed/rollbar.js">

        <title>See Atlassian Team ‘25 Europe: muljed ja uued ideed at Atlassian Community Events Tallinn
</title>
        <meta name="keywords" content="">
        <meta name="description" content="Atlassian Community Events Tallinn presents Atlassian Team ‘25 Europe: muljed ja uued ideed | Oct 21, 2025. Find event and ticket information.
">
...
<meta name="twitter:title" content="Atlassian Team ‘25 Europe: muljed ja uued ideed" />

    <meta name="twitter:description" content="In-person Event - 🚀 Atlassian Team ‘25 Europe: muljed &amp; uued ideedAtlassian Team &#x27;25 Europe konverents toimub sel aastal Barcelonas ja too..." />


<meta name="twitter:image" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/events/blob_gMZP15H_FSubmUs" />
        ...
        <meta property="og:image" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/events/blob_gMZP15H_FSubmUs" />
        <meta property="og:image:secure_url" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/events/blob_gMZP15H_FSubmUs" />
        <meta property="og:image:width" content="1080" />
        <meta property="og:image:height" content="1080" />
    

        <meta property="og:title" content="Atlassian Team ‘25 Europe: muljed ja uued ideed | Atlassian Community Events" />
        <meta property="og:description" content="In-person Event - 🚀 Atlassian Team ‘25 Europe: muljed &amp; uued ideedAtlassian Team &#x27;25 Europe konverents toimub sel aastal Barcelonas ja too..."/>
        <meta property="og:url" content="https://ace.atlassian.com/events/details/atlassian-tallinn-presents-atlassian-team-25-europe-muljed-ja-uued-ideed/rollbar.js" />
...
<meta property="og:locale" content="en_US" />
    ...
    <meta property="event:start_time" content="Oct 21, 2025, 4:00 PM (EEST)" />
    
    <meta property="event:end_time" content="Oct 21, 2025, 8:00 PM (EEST)" />

<meta property="event:attending_count" content="31" />
<meta property="event:ticket_uri" content="https://ace.atlassian.com/events/details/atlassian-tallinn-presents-atlassian-team-25-europe-muljed-ja-uued-ideed/#/purchase" />
...
<meta name="twitter:label1" value="Where" />
    ...
    <meta name="twitter:data1" value="In-person Event - Trinidad Wiseman - 14 Meistri Tallinn 13517" />

<meta name="twitter:label2" value="When" />

    
    <meta name="twitter:data2" value="Oct 21, 2025, 4:00 PM (EEST)" />
...
<link rel="stylesheet" href="/static/js/ticketwidget.css?v=4ca06c5bf69ab349c7b9499eeea78592081ea99e">
        ...
        <script>
            ...
            Globals.signup_url                  = '/signup/?next=/events/details/atlassian-tallinn-presents-atlassian-team-25-europe-muljed-ja-uued-ideed/rollbar.js';
            Globals.login_url                   = '/accounts/login/?next=/events/details/atlassian-tallinn-presents-atlassian-team-25-europe-muljed-ja-uued-ideed/rollbar.js';
            Globals.logout_url                  = '/accounts/logout/?next=/events/details/atlassian-tallinn-presents-atlassian-team-25-europe-muljed-ja-uued-ideed/rollbar.js';
            ...
            Globals.global_search_key              = '';
            ...
            Globals.global_attendee_index       = 'e54wR5pJcJZWduBpVKq3cNPjuojZTPcVOx8p2ayLOFxUSjHy63TdVnPfNWZ3l48c';
...
Globals.eventInfo = {
    ...
    Globals.slug = 'atlassian-tallinn-presents-atlassian-team-25-europe-muljed-ja-uued-ideed';
    Globals.rsvp_only = true;
    Globals.absoluteURL = 'https://ace.atlassian.com/events/details/atlassian-tallinn-presents-atlassian-team-25-europe-muljed-ja-uued-ideed/rollbar.js';
    Globals.socialShareText = 'I\u0027m attending {site_title} {chapter_title} w/ {event_title} on {event_start_date}.{event_static_url}';
    Globals.staticURL = 'https://ace.atlassian.com/e/m22n4c/';
    Globals.twitterHandle = '@atlassian';
    Globals.hideFeeColumn = false;
    Globals.twitterWithFallback = 'Atlassian Team ‘25 Europe: muljed ja uued ideed';
    Globals.companyHashtag = '#AtlassianCommunity';
    Globals.twitterCompanyWithFallback = '';
    Globals.cityName = 'Tallinn';
    Globals.chapterSlug = 'tallinn';
    Globals.chapterId = 546;
    Globals.eventDate = 'Oct 21, 2025';
    Globals.eventDateTime = 'Oct 21, 4:00 PM';
    
        Globals.eventInfo.minutesUntilStart = 15746;
        Globals.eventInfo.minutesUntilStartTimer = 15746;
    
    Globals.eventInfo.tickets = [{"id":10855,"event":11356,"title":"General Admission","audience_type":"IN_PERSON","description":"","access_code":"","visible":true,"price":0.0,"fees":0.0,"total_price":0.0,"available":10,"total_count":75,"sale_start_date":"2025-09-24T12:12:19+03:00","sale_start_date_naive":"2025-09-24T12:12:19","sale_start_date_derived_from_event_publish":true,"sale_end_date":"2025-10-21T20:00:00+03:00","sale_end_date_naive":"2025-10-21T20:00:00","sale_end_date_derived_from_event_end":true,"min_per_order":0,"max_per_order":10,"is_for_sale":true,"can_delete":false,"currency":"USD","waitlist_enabled":false,"reported_price_includes_fees":false,"reported_price":0.0,"reported_fees":0.0,"used":26,"waitlist_count":0,"attendee_count":26,"discount_code":"","reported_original_price":0.0}];
    Globals.eventInfo.payment_methods = [];
    Globals.eventInfo.currency = "USD";
    Globals.eventInfo.startDate = "2025-10-21T13:00:00Z";
    Globals.eventInfo.endDate = "2025-10-21T17:00:00Z";
    Globals.eventInfo.title = "Atlassian Team ‘25 Europe: muljed ja uued ideed";
    Globals.eventInfo.location = "Trinidad Wiseman, 14 Meistri, Tallinn, 13517";
    Globals.eventInfo.description = "🚀 Atlassian Team ‘25 Europe: muljed \u0026 uued ideedAtlassian Team \u002725 Europe konverents toimub sel aastal Barcelonas ja too...";
    Globals.supportGuestRegistration = false;
    
        Globals.eventInfo.audienceType = 'IN_PERSON',
        Globals.eventInfo.virtualEvent = false;
    
    Globals.eventInfo.timezoneAbbreviation = 'EEST';

    
        
            Globals.eventInfo.url = '/events/details/atlassian-tallinn-presents-atlassian-team-25-europe-muljed-ja-uued-ideed/';
...
<script id="event_tags" type="application/json">["Community", "Team '25"]</script>
...
<ul class="nav navbar-nav navbar-right top-nav-dragon"><li class="navbar-menu  active-page"><a href="/events/" class="None"   >
    ...
    <script type="application/ld+json">{"@context": "https://schema.org", "@type": "Event", "name": "Atlassian Team \u201825 Europe: muljed ja uued ideed", "startDate": "2025-10-21T16:00:00+03:00", "endDate": "2025-10-21T20:00:00+03:00", "description": "\ud83d\ude80 Atlassian Team \u201825 Europe: muljed \u0026 uued ideedAtlassian Team '25 Europe konverents toimub sel aastal Barcelonas ja too...", "organizer": {"@type": "Organization", "name": "Atlassian Community Events", "url": "https://ace.atlassian.com"}, "location": {"@type": "Place", "name": "Trinidad Wiseman", "address": {"@type": "PostalAddress", "streetAddress": "14 Meistri", "addressLocality": "Tallinn", "postalCode": "13517", "addressRegion": "Harju County", "addressCountry": "US"}}, "eventStatus": "https://schema.org/EventScheduled", "eventAttendanceMode": "https://schema.org/OfflineEventAttendanceMode", "image": ["https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/events/blob_gMZP15H_FSubmUs"], "offers": {"@type": "Offer", "url": "https://ace.atlassian.com/events/details/atlassian-tallinn-presents-atlassian-team-25-europe-muljed-ja-uued-ideed/", "availability": "http://schema.org/LimitedAvailability", "validFrom": "2025-09-24T09:12:19Z", "validThrough": "2025-10-21T17:00:00Z", "price": 0}}</script>
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><li class="people-card general-card" data-testid="organizer-card"><div style="background-image:url(https://res.cloudinary.com/startup-grind/image/upload/c_fill,w_250,h_250,g_center/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/avatars/kerli_suve.jpg);border-radius:50%;width:175px;height:175px;background-size:cover" role="img" aria-label="Kerli Suve avatar"></div><div class="People-styles-info-D3x35"><h2 class="Text-Text__h2_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__h2_2lnce" dir="auto">Kerli<!-- --> <!-- -->Suve</h2><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Community Leader</p></div><div><a class="Button-styles__button_iwr8t Button-styles__link_iwr8t Button-styles__medium_iwr8t Button-styles__outlined_iwr8t Button-styles__standard_iwr8t" aria-label="See Kerli Suve&#x27;s bio" href="/u/m6ny4x/" rel="noopener">See bio</a></div></li></div><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><li class="people-card general-card" data-testid="organizer-card"><div style="background-image:url(https://res.cloudinary.com/startup-grind/image/upload/c_fill,w_250,h_250,g_center/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/avatars/elis_augasm%C3%A4gi.jpg);border-radius:50%;width:175px;height:175px;background-size:cover" role="img" aria-label="Elis Augasmägi avatar"></div><div class="People-styles-info-D3x35"><h2 class="Text-Text__h2_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__h2_2lnce" dir="auto">Elis<!-- --> <!-- -->Augasmägi</h2><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Estonian Business and Innovation Agency</p><p class="Text-Text__p_2lnce Text-Text__center_2lnce Text-Text__dark_2lnce Text-Text__block_2lnce Text-Text__small_2lnce Text-Text__none_2lnce Text-Text__base_2lnce" dir="auto">Community Leader</p></div><div><a class="Button-styles__button_iwr8t Button-styles__link_iwr8t Button-styles__medium_iwr8t Button-styles__outlined_iwr8t Button-styles__standard_iwr8t" aria-label="See Elis Augasmägi&#x27;s bio" href="/u/mjuayg/" rel="noopener">See bio</a></div></li></div><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
<script>
  Globals.forum_uuid = "events.event.11356";
  
  
</script>

  <div id="react-topic-create" data-forum-uuid="events.event.11356" class="pull-right"></div>
    ...
    <div class="modal-dialog contact-host" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="contact-host container" method="post" chapterid="546" eventid="11356">
                    <input type="hidden" name="csrfmiddlewaretoken" value="4XI13i0jtU0APn43aTW7dX1J7T9Yz3ttEpMUen9l5QyyucaclcphWx1FqrP21ipK">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row message-row">
                    <p class="not-ready-message">This event will start on Oct 21, 4:00 PM (EEST) </p>
