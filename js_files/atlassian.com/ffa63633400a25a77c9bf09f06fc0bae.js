<!doctype html>
    ...
    <head>
        ...
        <link rel="canonical" href="https://ace.atlassian.com/events/details/atlassian-cleveland-presents-credit-rating-giant-drives-high-velocity-itsm/rollbar.js">

        <title>See Credit Rating Giant Drives High Velocity ITSM at Atlassian Community Events Cleveland
</title>
        <meta name="keywords" content="">
        <meta name="description" content="Atlassian Community Events Cleveland presents Credit Rating Giant Drives High Velocity ITSM | Oct 23, 2025. Find event and ticket information.
">
...
<meta name="twitter:title" content="Credit Rating Giant Drives High Velocity ITSM" />

    <meta name="twitter:description" content="In-person Event - Join us for an engaging evening of craft beer and real-world ITSM insights at Masthead Brewery!" />


<meta name="twitter:image" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/events/blob_lkZcOVQ" />
        ...
        <meta property="og:image" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/events/blob_lkZcOVQ" />
        <meta property="og:image:secure_url" content="https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,h_1080,q_100,w_1080/v1/gcs/platform-data-atlassian/events/blob_lkZcOVQ" />
        <meta property="og:image:width" content="1080" />
        <meta property="og:image:height" content="1080" />
    

        <meta property="og:title" content="Credit Rating Giant Drives High Velocity ITSM | Atlassian Community Events" />
        <meta property="og:description" content="In-person Event - Join us for an engaging evening of craft beer and real-world ITSM insights at Masthead Brewery!"/>
        <meta property="og:url" content="https://ace.atlassian.com/events/details/atlassian-cleveland-presents-credit-rating-giant-drives-high-velocity-itsm/rollbar.js" />
...
<meta property="og:locale" content="en_US" />
    ...
    <meta property="event:start_time" content="Oct 23, 2025, 6:00 PM (EDT)" />
    
    <meta property="event:end_time" content="Oct 23, 2025, 7:30 PM (EDT)" />

<meta property="event:attending_count" content="6" />
<meta property="event:ticket_uri" content="https://ace.atlassian.com/events/details/atlassian-cleveland-presents-credit-rating-giant-drives-high-velocity-itsm/#/purchase" />
...
<meta name="twitter:label1" value="Where" />
    ...
    <meta name="twitter:data1" value="In-person Event - Masthead Brewing Co. - 1261 Superior Avenue Cleveland 44114" />

<meta name="twitter:label2" value="When" />

    
    <meta name="twitter:data2" value="Oct 23, 2025, 6:00 PM (EDT)" />
...
<link rel="stylesheet" href="/static/js/ticketwidget.css?v=4ca06c5bf69ab349c7b9499eeea78592081ea99e">
        ...
        <script>
            ...
            Globals.signup_url                  = '/signup/?next=/events/details/atlassian-cleveland-presents-credit-rating-giant-drives-high-velocity-itsm/rollbar.js';
            Globals.login_url                   = '/accounts/login/?next=/events/details/atlassian-cleveland-presents-credit-rating-giant-drives-high-velocity-itsm/rollbar.js';
            Globals.logout_url                  = '/accounts/logout/?next=/events/details/atlassian-cleveland-presents-credit-rating-giant-drives-high-velocity-itsm/rollbar.js';
            ...
            Globals.global_attendee_index       = 'dSxAaFdeVg9ZBxK1010kUaOykrPb08E9AgbThwVcYqI2egjLN9q88QCVRR9YUig7';
...
Globals.eventInfo = {
    ...
    Globals.slug = 'atlassian-cleveland-presents-credit-rating-giant-drives-high-velocity-itsm';
    Globals.rsvp_only = true;
    Globals.absoluteURL = 'https://ace.atlassian.com/events/details/atlassian-cleveland-presents-credit-rating-giant-drives-high-velocity-itsm/rollbar.js';
    Globals.socialShareText = 'I\u0027m attending {site_title} {chapter_title} w/ {event_title} on {event_start_date}.{event_static_url}';
    Globals.staticURL = 'https://ace.atlassian.com/e/mvfh9z/';
    Globals.twitterHandle = '@atlassian';
    Globals.hideFeeColumn = false;
    Globals.twitterWithFallback = 'Credit Rating Giant Drives High Velocity ITSM';
    Globals.companyHashtag = '#AtlassianCommunity';
    Globals.twitterCompanyWithFallback = '';
    Globals.cityName = 'Cleveland';
    Globals.chapterSlug = 'cleveland';
    Globals.chapterId = 168;
    Globals.eventDate = 'Oct 23, 2025';
    Globals.eventDateTime = 'Oct 23, 6:00 PM';
    
        Globals.eventInfo.minutesUntilStart = 19166;
        Globals.eventInfo.minutesUntilStartTimer = 19166;
    
    Globals.eventInfo.tickets = [{"id":10891,"event":11390,"title":"General Admission","audience_type":"IN_PERSON","description":"","access_code":"","visible":true,"price":0.0,"fees":0.0,"total_price":0.0,"available":10,"total_count":1000,"sale_start_date":"2025-09-29T14:41:03-04:00","sale_start_date_naive":"2025-09-29T14:41:03","sale_start_date_derived_from_event_publish":true,"sale_end_date":"2025-10-23T19:30:00-04:00","sale_end_date_naive":"2025-10-23T19:30:00","sale_end_date_derived_from_event_end":true,"min_per_order":0,"max_per_order":10,"is_for_sale":true,"can_delete":false,"currency":"USD","waitlist_enabled":false,"reported_price_includes_fees":false,"reported_price":0.0,"reported_fees":0.0,"used":4,"waitlist_count":0,"attendee_count":4,"discount_code":"","reported_original_price":0.0}];
    Globals.eventInfo.payment_methods = [];
    Globals.eventInfo.currency = "USD";
    Globals.eventInfo.startDate = "2025-10-23T22:00:00Z";
    Globals.eventInfo.endDate = "2025-10-23T23:30:00Z";
    Globals.eventInfo.title = "Credit Rating Giant Drives High Velocity ITSM";
    Globals.eventInfo.location = "Masthead Brewing Co., 1261 Superior Avenue, Cleveland, 44114";
    Globals.eventInfo.description = "Join us for an engaging evening of craft beer and real\u002Dworld ITSM insights at Masthead Brewery!";
    ...
    Globals.eventInfo.timezoneAbbreviation = 'EDT';
            ...
            Globals.eventInfo.url = '/events/details/atlassian-cleveland-presents-credit-rating-giant-drives-high-velocity-itsm/';
...
<script id="event_tags" type="application/json">["Jira Service Management", "Live Learning"]</script>
...
<ul class="nav navbar-nav navbar-right top-nav-dragon"><li class="navbar-menu  active-page"><a href="/events/" class="None"   >
    ...
    <script type="application/ld+json">{"@context": "https://schema.org", "@type": "Event", "name": "Credit Rating Giant Drives High Velocity ITSM", "startDate": "2025-10-23T18:00:00-04:00", "endDate": "2025-10-23T19:30:00-04:00", "description": "Join us for an engaging evening of craft beer and real-world ITSM insights at Masthead Brewery!", "organizer": {"@type": "Organization", "name": "Atlassian Community Events", "url": "https://ace.atlassian.com"}, "location": {"@type": "Place", "name": "Masthead Brewing Co.", "address": {"@type": "PostalAddress", "streetAddress": "1261 Superior Avenue", "addressLocality": "Cleveland", "postalCode": "44114", "addressRegion": "OH", "addressCountry": "US"}}, "eventStatus": "https://schema.org/EventScheduled", "eventAttendanceMode": "https://schema.org/OfflineEventAttendanceMode", "image": ["https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/events/blob_lkZcOVQ"], "offers": {"@type": "Offer", "url": "https://ace.atlassian.com/events/details/atlassian-cleveland-presents-credit-rating-giant-drives-high-velocity-itsm/", "availability": "http://schema.org/LimitedAvailability", "validFrom": "2025-09-29T18:41:03Z", "validThrough": "2025-10-23T23:30:00Z", "price": 0}, "performer": {"@type": "Person", "name": "Patrick Howell", "image": "https://res.cloudinary.com/startup-grind/image/upload/c_fill,dpr_2.0,f_auto,g_center,q_auto:good/v1/gcs/platform-data-atlassian/events/Patrick%20Howell.jpg"}}</script>
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><div class="People-styles-peopleWrapper-vG5gN" data-testid="people-section"><h1 style="color:#253858" class="event-page general-h1">Speaker</h1><ul><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
--chip-size-large-padding: 10px 16px;
--chip-size-large-gap: 12px;
}</style><div class="People-styles-peopleWrapper-vG5gN" data-testid="people-section"><h1 style="color:#253858" class="event-page general-h1">Community Champion</h1><ul><div class="theme-provider-namespace-people-card"><style>.theme-provider-namespace-people-card {
--accordion-iconColor-rgb: 60, 65, 83;
--accordion-iconColor: #3C4153;
--accordion-border-radius: 4px;
--accordion-border-width: 1px;
...
<script>
  Globals.forum_uuid = "events.event.11390";
  
  
</script>

  <div id="react-topic-create" data-forum-uuid="events.event.11390" class="pull-right"></div>
    ...
    <div class="modal-dialog contact-host" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="contact-host container" method="post" chapterid="168" eventid="11390">
                    <input type="hidden" name="csrfmiddlewaretoken" value="izP1KgMD3u5EoIWF4ubNsq82enb4GdlvFXtkR7uB6EEH1rvpRCBBG6WpLNvRAnXt">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row message-row">
                    <p class="not-ready-message">This event will start on Oct 23, 6:00 PM (EDT) </p>
